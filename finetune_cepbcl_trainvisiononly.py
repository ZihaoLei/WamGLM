...
def forward_step_eval_acc(data_iterator, model, args, timers):
    """Forward step eval for computing accuracy."""
    ...
    accuracy = torch.tensor(accuracy, dtype=dtype, device=device)
...
if __name__ == '__main__':
    ...
    if train_vit:
        ...
        training_main(args, model_cls=model, forward_step_function=forward_step_adaptation,
                      create_dataset_function=create_adaptation_dataset_function, collate_fn=data_collator, forward_step_eval=forward_step_eval_acc)
